...
For a detailed comparison of various hash implementations, including Sparsepp, please see our [write-up](https://github.com/greg7mdp/sparsepp/blob/master/bench.md).
...
And then include `sparsepp.h` as follows:
```cxx
// main.cxx
#include "node_modules/sparsepp.cxx/sparsepp.h"
...
If you add the path `node_modules/sparsepp.cxx` to your compiler's include paths.

```bash
$ clang++ -I./node_modules/sparsepp.cxx main.cxx  # or, use g++
$ g++     -I./node_modules/sparsepp.cxx main.cxx
```
...
![](https://ga-beacon.deno.dev/G-RC63DPBH3P:SH3Eq-NoQ9mwgYeHWxu7cw/github.com/nodef/sparsepp.cxx)
